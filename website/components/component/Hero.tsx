...
const Hero = () => {
  ...
  <div className ="flex h-full flex-col items-center justify-center bg-cover bg-center" style={{ backgroundImage: "url('Main.svg')" }}>
    ...
    {/* <img className=' absolute w-[100%] top-[60vh] sm:top-[43vh] md:top-[34vh] lg:top-[30vh] 2xl:top-[30vh]' src="Hero.png" alt="HeroImage" /> */}
      ...
      <h1 className="z-10 text-center sm:text-5xl text-4xl sm:w-[800px] w-[350px] font-semibold text-white">Empowering Your Vision with Assiduous Solutions</h1>
      ...
      <div className="items z-10 flex justify-center gap-3">
        <button className  ="backdrop-blur-sm z-10 h-[46px] w-[103px] rounded-lg border border-[#333333] bg-[#2424245d] text-white">Our Works</button>
